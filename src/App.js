              ...
              <>
                ...
                <>
                  <div className='secondPage'>
                    ...
                    <div className='backPage_grid_4'>
                      <div>
                        <div className='typing-text4' style={{ fontSize: "20px" }}> CONTROL OR DELETE </div>
                        <div className='typing-text5'>=======================================================================================</div>
                        <div className='typing-text6'>- 제작 : AROUNDKorea CORP.</div>
                        <div className='typing-text5'>=======================================================================================</div>
                        <div className='typing-text7'>- 기획 : IxieL, ㅇㅅㅎ</div>
                        <div className='typing-text8'>- 디자인 : ㅇㅅㅎ </div>
                 ...
                 <div className='secondPage'>
                   ...
                   <div className='backPage_grid_4'>
                     <div>
                       ...
                       <div className='typing-text10'>- 개발 : IxieL</div>
                       <div className='typing-text11'>- 그 외 잡다한 것 모두 : ㅇㅅㅎ, IxieL</div>
                       <div className='choiceButton2'><button className='console-btn' onClick={() => setStart()}> 확인 </button></div>
                     </div>
                   </div>
                 </div>
               </>
